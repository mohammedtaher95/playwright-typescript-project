...
class MyAccountPage {
  ...
  elements = {
    changePasswordLink: () => this.page.locator("xpath=//a[@href='/customer/changepassword']"),
    ...
    changePasswordBtn: () => this.page.locator("button.button-1.change-password-button"),
  ...
  async checkThatChangeMessageShouldBeDisplayed() {
    await this.expect(this.elements.changeResult()).toContainText("Password was changed");
    return this;
  }
